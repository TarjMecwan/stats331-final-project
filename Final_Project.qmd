...
We hypothesize that there will be a nonlinear relationship between inflation rates and poverty rates in the world. Intuitively, frequent fluctuations in inflation rates will be associated with higher poverty rates, as economic instability disproportionately affects people of lower incomes. As such, we think that a linear model will not be sufficient in evaluating the relationship between poverty rates and inflation. 
